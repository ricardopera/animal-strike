...
export const Sfx = {
  ...
  shootSMG: () => blip({ freq: 420, type: 'square', dur: 0.04, gain: 0.09, sweep: -100 }),
  shootShotgun: () => blip({ freq: 120, type: 'sawtooth', dur: 0.22, gain: 0.22, sweep: -80 }),
  shootPistol: () => blip({ freq: 380, type: 'square', dur: 0.05, gain: 0.11, sweep: -140 }),
